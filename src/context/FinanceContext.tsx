...
// import { addGoal as addGoalService,   getGoals as getGoalsService, updateGoal as updateGoalService, type Goal as DBGoal,} from "../services/financeService";
...
//    // Load goals from Appwrite when user logs in
//   useEffect(() => {
//     if (!user?.$id) return;
//     (async () => {
//       try {
...
//     try {
//       const newGoalDoc = await addGoalService({
//         userId: user.$id,
//         title: g.title,
//         targetAmount: g.targetAmount,
//         deadline: g.deadline,
...
//     setGoals((prev) =>
//       prev.map((g) => (g.id === id ? { ...g, savedAmount: newSavedAmount } : g))
//     );

//     try {
//       await updateGoalService(id, { savedAmount: newSavedAmount });
